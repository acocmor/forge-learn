...
namespace forgeSample.Controllers
{
    ...
    public class OSSController : ControllerBase
    {
        ...
        public OSSController(IWebHostEnvironment env, IOAuthService authService)
        {
            _env = env;
            _authService = authService;
            ClientId = _authService.GetSettings("FORGE_CLIENT_ID");
        }
        ...
        public async Task<IList<TreeNode>> GetOSSAsync(string id)
        {
            ...
            dynamic oauth = await _authService.GetInternalAsync();
